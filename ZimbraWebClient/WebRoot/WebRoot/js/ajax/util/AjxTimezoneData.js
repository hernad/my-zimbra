 ...
 * <p>
 * Generated at Sun Sep 30 18:19:59 UTC 2018
 * @private
 */
AjxTimezoneData = {};

AjxTimezoneData.TRANSITION_YEAR = 2018;
...
AjxTimezoneData.TIMEZONE_RULES = [
	...
	{ serverId: "America/Anchorage", clientId: "America/Anchorage", score: 200, 
	  standard: { offset: -540, mon: 11, week: 1, wkday: 1, hour: 2, min: 0, sec: 0, trans: [ 2018, 11, 4 ], tzname: "AKST" },
	  daylight: { offset: -480, mon: 3, week: 2, wkday: 1, hour: 2, min: 0, sec: 0, trans: [ 2018, 3, 11 ], tzname: "AKDT" }
	},
	{ serverId: "America/Los_Angeles", clientId: "America/Los_Angeles", score: 200, 
	  standard: { offset: -480, mon: 11, week: 1, wkday: 1, hour: 2, min: 0, sec: 0, trans: [ 2018, 11, 4 ], tzname: "PST" },
	  daylight: { offset: -420, mon: 3, week: 2, wkday: 1, hour: 2, min: 0, sec: 0, trans: [ 2018, 3, 11 ], tzname: "PDT" }
	},
	...
	{ serverId: "America/Chihuahua", clientId: "America/Chihuahua", score: 100, 
	  standard: { offset: -420, mon: 10, week: -1, wkday: 1, hour: 2, min: 0, sec: 0, trans: [ 2018, 10, 28 ], tzname: "MST" },
	  daylight: { offset: -360, mon: 4, week: 1, wkday: 1, hour: 2, min: 0, sec: 0, trans: [ 2018, 4, 1 ], tzname: "MDT" }
	},
	{ serverId: "America/Denver", clientId: "America/Denver", score: 200, 
	  standard: { offset: -420, mon: 11, week: 1, wkday: 1, hour: 2, min: 0, sec: 0, trans: [ 2018, 11, 4 ], tzname: "MST" },
	  daylight: { offset: -360, mon: 3, week: 2, wkday: 1, hour: 2, min: 0, sec: 0, trans: [ 2018, 3, 11 ], tzname: "MDT" }
	},
	...
	{ serverId: "America/Chicago", clientId: "America/Chicago", score: 200, 
	  standard: { offset: -360, mon: 11, week: 1, wkday: 1, hour: 2, min: 0, sec: 0, trans: [ 2018, 11, 4 ], tzname: "CST" },
	  daylight: { offset: -300, mon: 3, week: 2, wkday: 1, hour: 2, min: 0, sec: 0, trans: [ 2018, 3, 11 ], tzname: "CDT" }
	},
	...
	{ serverId: "America/Mexico_City", clientId: "America/Mexico_City", score: 100, 
	  standard: { offset: -360, mon: 10, week: -1, wkday: 1, hour: 2, min: 0, sec: 0, trans: [ 2018, 10, 28 ], tzname: "CST" },
	  daylight: { offset: -300, mon: 4, week: 1, wkday: 1, hour: 2, min: 0, sec: 0, trans: [ 2018, 4, 1 ], tzname: "CDT" }
	},
	...
	{ serverId: "America/Indiana/Indianapolis", clientId: "America/Indiana/Indianapolis", score: 100, 
	  standard: { offset: -300, mon: 11, week: 1, wkday: 1, hour: 2, min: 0, sec: 0, trans: [ 2018, 11, 4 ], tzname: "EST" },
	  daylight: { offset: -240, mon: 3, week: 2, wkday: 1, hour: 2, min: 0, sec: 0, trans: [ 2018, 3, 11 ], tzname: "EDT" }
	},
	...
	{ serverId: "America/Asuncion", clientId: "America/Asuncion", score: 100, 
	  standard: { offset: -240, mon: 3, week: -1, wkday: 1, hour: 0, min: 0, sec: 0, trans: [ 2018, 3, 25 ], tzname: "PYT" },
	  daylight: { offset: -180, mon: 10, week: 1, wkday: 1, hour: 0, min: 0, sec: 0, trans: [ 2018, 10, 7 ], tzname: "PYST" }
	},
	{ serverId: "America/Cuiaba", clientId: "America/Cuiaba", score: 100, 
	  standard: { offset: -240, mon: 2, week: 3, wkday: 1, hour: 0, min: 0, sec: 0, trans: [ 2018, 2, 18 ], tzname: "AMT" },
	  daylight: { offset: -180, mon: 10, week: 3, wkday: 1, hour: 0, min: 0, sec: 0, trans: [ 2018, 10, 21 ], tzname: "AMST" }
	},
	...
	{ serverId: "America/Halifax", clientId: "America/Halifax", score: 100, 
	  standard: { offset: -240, mon: 11, week: 1, wkday: 1, hour: 2, min: 0, sec: 0, trans: [ 2018, 11, 4 ], tzname: "AST" },
	  daylight: { offset: -180, mon: 3, week: 2, wkday: 1, hour: 2, min: 0, sec: 0, trans: [ 2018, 3, 11 ], tzname: "ADT" }
	},
	{ serverId: "America/St_Johns", clientId: "America/St_Johns", score: 100, 
	  standard: { offset: -210, mon: 11, week: 1, wkday: 1, hour: 2, min: 0, sec: 0, trans: [ 2018, 11, 4 ], tzname: "NST" },
	  daylight: { offset: -150, mon: 3, week: 2, wkday: 1, hour: 2, min: 0, sec: 0, trans: [ 2018, 3, 11 ], tzname: "NDT" }
	},
	...
	{ serverId: "America/Godthab", clientId: "America/Godthab", score: 100, 
	  standard: { offset: -180, mon: 10, week: -1, wkday: 1, hour: 1, min: 0, sec: 0, trans: [ 2018, 10, 28 ], tzname: "WGT" },
	  daylight: { offset: -120, mon: 3, week: -1, wkday: 1, hour: 2, min: 0, sec: 0, trans: [ 2018, 3, 25 ], tzname: "WGST" }
	},
	...
	{ serverId: "America/Sao_Paulo", clientId: "America/Sao_Paulo", score: 100, 
	  standard: { offset: -180, mon: 2, week: 3, wkday: 1, hour: 0, min: 0, sec: 0, trans: [ 2018, 2, 18 ], tzname: "BRT" },
	  daylight: { offset: -120, mon: 10, week: 3, wkday: 1, hour: 0, min: 0, sec: 0, trans: [ 2018, 10, 21 ], tzname: "BRST" }
	},
	...
	{ serverId: "Atlantic/Azores", clientId: "Atlantic/Azores", score: 100, 
	  standard: { offset: -60, mon: 10, week: -1, wkday: 1, hour: 1, min: 0, sec: 0, trans: [ 2018, 10, 28 ], tzname: "AZOT" },
	  daylight: { offset: 0, mon: 3, week: -1, wkday: 1, hour: 0, min: 0, sec: 0, trans: [ 2018, 3, 25 ], tzname: "AZOST" }
	},
	...
	{ serverId: "Africa/Casablanca", clientId: "Africa/Casablanca", score: 100, 
	  standard: { offset: 0, mon: 6, week: 1, wkday: 1, hour: 3, min: 0, sec: 0, trans: [ 2018, 6, 3 ], tzname: "WET" },
	  daylight: { offset: 60, mon: 7, week: 2, wkday: 1, hour: 2, min: 0, sec: 0, trans: [ 2018, 7, 8 ], tzname: "WEST" }
	},
	...
	{ serverId: "Europe/London", clientId: "Europe/London", score: 100, 
	  standard: { offset: 0, mon: 10, week: -1, wkday: 1, hour: 2, min: 0, sec: 0, trans: [ 2018, 10, 28 ], tzname: "GMT/BST" },
	  daylight: { offset: 60, mon: 3, week: -1, wkday: 1, hour: 1, min: 0, sec: 0, trans: [ 2018, 3, 25 ], tzname: "GMT/BST" }
	},
	...
	{ serverId: "Africa/Windhoek", clientId: "Africa/Windhoek", score: 100, 
	  standard: { offset: 60, mon: 4, week: 1, wkday: 1, hour: 2, min: 0, sec: 0, trans: [ 2018, 4, 1 ], tzname: "WAT" },
	  daylight: { offset: 120, mon: 9, week: 1, wkday: 1, hour: 2, min: 0, sec: 0, trans: [ 2018, 9, 2 ], tzname: "WAST" }
	},
	{ serverId: "Europe/Belgrade", clientId: "Europe/Belgrade", score: 100, 
	  standard: { offset: 60, mon: 10, week: -1, wkday: 1, hour: 3, min: 0, sec: 0, trans: [ 2018, 10, 28 ], tzname: "CET" },
	  daylight: { offset: 120, mon: 3, week: -1, wkday: 1, hour: 2, min: 0, sec: 0, trans: [ 2018, 3, 25 ], tzname: "CEST" }
	},
	...
	{ serverId: "Asia/Amman", clientId: "Asia/Amman", score: 100, 
	  standard: { offset: 120, mon: 10, week: -1, wkday: 6, hour: 1, min: 0, sec: 0, trans: [ 2018, 10, 26 ], tzname: "EET" },
	  daylight: { offset: 180, mon: 3, week: -1, wkday: 5, hour: 23, min: 59, sec: 59, trans: [ 2018, 3, 29 ], tzname: "EEST" }
	},
	{ serverId: "Asia/Beirut", clientId: "Asia/Beirut", score: 100, 
	  standard: { offset: 120, mon: 10, week: -1, wkday: 1, hour: 0, min: 0, sec: 0, trans: [ 2018, 10, 28 ], tzname: "EET" },
	  daylight: { offset: 180, mon: 3, week: -1, wkday: 1, hour: 0, min: 0, sec: 0, trans: [ 2018, 3, 25 ], tzname: "EEST" }
	},
	{ serverId: "Asia/Damascus", clientId: "Asia/Damascus", score: 100, 
	  standard: { offset: 120, mon: 10, week: -1, wkday: 6, hour: 0, min: 0, sec: 0, trans: [ 2018, 10, 26 ], tzname: "EET" },
	  daylight: { offset: 180, mon: 3, week: -1, wkday: 6, hour: 0, min: 0, sec: 0, trans: [ 2018, 3, 30 ], tzname: "EEST" }
	},
	{ serverId: "Asia/Jerusalem", clientId: "Asia/Jerusalem", score: 100, 
	  standard: { offset: 120, mon: 10, week: -1, wkday: 1, hour: 2, min: 0, sec: 0, trans: [ 2018, 10, 28 ], tzname: "IST" },
	  daylight: { offset: 180, mon: 3, week: -1, wkday: 6, hour: 2, min: 0, sec: 0, trans: [ 2018, 3, 30 ], tzname: "IDT" }
	},
	{ serverId: "Europe/Athens", clientId: "Europe/Athens", score: 200, 
	  standard: { offset: 120, mon: 10, week: -1, wkday: 1, hour: 4, min: 0, sec: 0, trans: [ 2018, 10, 28 ], tzname: "EET" },
	  daylight: { offset: 180, mon: 3, week: -1, wkday: 1, hour: 3, min: 0, sec: 0, trans: [ 2018, 3, 25 ], tzname: "EEST" }
	},
	...
	{ serverId: "Asia/Tehran", clientId: "Asia/Tehran", score: 100, 
	  standard: { offset: 210, mon: 9, week: 3, wkday: 4, hour: 0, min: 0, sec: 0, trans: [ 2018, 9, 19 ], tzname: "IRST" },
	  daylight: { offset: 270, mon: 3, week: 3, wkday: 2, hour: 0, min: 0, sec: 0, trans: [ 2018, 3, 19 ], tzname: "IRDT" }
	},
	{ serverId: "Asia/Baku", clientId: "Asia/Baku", score: 100, 
	  standard: { offset: 240, mon: 10, week: -1, wkday: 1, hour: 5, min: 0, sec: 0, trans: [ 2018, 10, 28 ], tzname: "AZT" },
	  daylight: { offset: 300, mon: 3, week: -1, wkday: 1, hour: 4, min: 0, sec: 0, trans: [ 2018, 3, 25 ], tzname: "AZST" }
	},
	...
	{ serverId: "Asia/Ulaanbaatar", clientId: "Asia/Ulaanbaatar", score: 100, 
	  standard: { offset: 480, mon: 9, week: -1, wkday: 7, hour: 0, min: 0, sec: 0, trans: [ 2018, 9, 29 ], tzname: "ULAT" },
	  daylight: { offset: 540, mon: 3, week: -1, wkday: 7, hour: 2, min: 0, sec: 0, trans: [ 2018, 3, 31 ], tzname: "ULAST" }
	},
	...
	{ serverId: "Australia/Adelaide", clientId: "Australia/Adelaide", score: 100, 
	  standard: { offset: 570, mon: 4, week: 1, wkday: 1, hour: 3, min: 0, sec: 0, trans: [ 2018, 4, 1 ], tzname: "ACST" },
	  daylight: { offset: 630, mon: 10, week: 1, wkday: 1, hour: 2, min: 0, sec: 0, trans: [ 2018, 10, 7 ], tzname: "ACDT" }
	},
	...
	{ serverId: "Australia/Hobart", clientId: "Australia/Hobart", score: 100, 
	  standard: { offset: 600, mon: 4, week: 1, wkday: 1, hour: 3, min: 0, sec: 0, trans: [ 2018, 4, 1 ], tzname: "AEST" },
	  daylight: { offset: 660, mon: 10, week: 1, wkday: 1, hour: 2, min: 0, sec: 0, trans: [ 2018, 10, 7 ], tzname: "AEDT" }
	},
	...
	{ serverId: "Pacific/Auckland", clientId: "Pacific/Auckland", score: 100, 
	  standard: { offset: 720, mon: 4, week: 1, wkday: 1, hour: 3, min: 0, sec: 0, trans: [ 2018, 4, 1 ], tzname: "NZST" },
	  daylight: { offset: 780, mon: 9, week: -1, wkday: 1, hour: 2, min: 0, sec: 0, trans: [ 2018, 9, 30 ], tzname: "NZDT" }
	},
	{ serverId: "Pacific/Fiji", clientId: "Pacific/Fiji", score: 100, 
	  standard: { offset: 720, mon: 1, week: 3, wkday: 1, hour: 3, min: 0, sec: 0, trans: [ 2018, 1, 21 ], tzname: "FJT" },
	  daylight: { offset: 780, mon: 11, week: 1, wkday: 1, hour: 2, min: 0, sec: 0, trans: [ 2018, 11, 4 ], tzname: "FJST" }
	},
	{ serverId: "Pacific/Apia", clientId: "Pacific/Apia", score: 100, 
	  standard: { offset: 780, mon: 4, week: 1, wkday: 1, hour: 4, min: 0, sec: 0, trans: [ 2018, 4, 1 ], tzname: "WSST" },
	  daylight: { offset: 840, mon: 9, week: -1, wkday: 1, hour: 3, min: 0, sec: 0, trans: [ 2018, 9, 30 ], tzname: "WSDT" }
	},
